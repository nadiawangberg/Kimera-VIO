...
void setIsam2Params(const BackendParams& vio_params,
  ...
  isam_param->cacheLinearizedFactors = false; // isam_param->setCacheLinearizedFactors(false);
  isam_param->evaluateNonlinearError = true; // isam_param->setEvaluateNonlinearError(true);
